...
function ECE() {
  ...
  const addQuestionPaper = async () => {
    ...
    const dataToSend = { ...formData, department: "ECE" };
    ...
    <div className='bg-gray-50 min-h-screen'>
      ...
      <div className='p-4 max-w-7xl mx-auto'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6'>
          <div>
            <h1 className='text-2xl font-bold'>🔌 Electronics & Communication Engineering</h1>
            <p className='text-gray-500'>Complete semester-wise question papers and study materials for ECE</p>
          </div>
