...
function DataScience() {
  ...
  const addQuestionPaper = async () => {
    ...
    const dataToSend = { ...formData, department: "DataScience" };
    ...
    <div className='bg-gray-50 min-h-screen'>
      ...
      <div className='p-4 max-w-7xl mx-auto'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8'>
          <div>
            <h1 className='text-2xl font-bold'>💻 Data Science Engineering</h1>
        ...
        <div className='my-10'>
          ...
          {filteredPapers.length > 0 ? (
            ...
            <div className="bg-white p-10 rounded-lg border border-dashed border-gray-300 text-center">
               <p className="text-gray-500 italic">No papers match "{searchTerm}"</p>
            </div>
          )}
        </div>
        ...
        <div className='p-6 rounded-xl shadow-md bg-[#e3f2fd] border border-blue-100'>
          <h2 className='mb-4 font-bold text-lg'>📤 Upload Resource</h2>
