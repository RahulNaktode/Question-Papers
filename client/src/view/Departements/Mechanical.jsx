...
function Mechanical() {
  ...
  const semesters = [
    { sem: 1, title: 'Semester 1', papers: ['Engineering Mechanics', 'Thermodynamics', 'Manufacturing'] },
    { sem: 2, title: 'Semester 2', papers: ['Machine Design', 'Fluid Mechanics', 'Heat Transfer'] },
    { sem: 3, title: 'Semester 3', papers: ['Automation & Control', 'IC Engines', 'Power Plants'] },
    { sem: 4, title: 'Semester 4', papers: ['Thermal Engineering', 'Renewable Energy', 'Industrial Management'] }
  ]
  ...
  return (
    <div>
      ...
      <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
        <h1>⚙️ Mechanical Engineering</h1>
        <p style={{ color: '#666', fontSize: '16px', marginBottom: '30px' }}>
          Complete semester-wise question papers and study materials for Mechanical Engineering
        </p>
