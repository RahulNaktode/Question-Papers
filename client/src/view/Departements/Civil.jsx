...
function Civil() {
  ...
  const semesters = [
    { sem: 1, title: 'Semester 1', papers: ['Engineering Mechanics', 'Mathematics', 'Building Materials'] },
    { sem: 2, title: 'Semester 2', papers: ['Surveying', 'Hydraulics', 'Structural Analysis'] },
    { sem: 3, title: 'Semester 3', papers: ['Concrete Technology', 'Transportation', 'Geotechnical'] },
    { sem: 4, title: 'Semester 4', papers: ['Environmental Engineering', 'Water Resources', 'Project Management'] }
  ]
    ...
    <div>
      ...
      <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#666', fontSize: '16px', marginBottom: '30px' }}>
          Complete semester-wise question papers and study materials for Civil Engineering
        </p>
