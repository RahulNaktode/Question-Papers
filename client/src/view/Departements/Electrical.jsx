...
function Electrical() {
  ...
  const semesters = [
    { sem: 1, title: 'Semester 1', papers: ['Circuit Theory', 'Mathematics', 'Electromagnetics'] },
    { sem: 2, title: 'Semester 2', papers: ['Electronic Devices', 'Digital Logic', 'Signals & Systems'] },
    { sem: 3, title: 'Semester 3', papers: ['Power Systems', 'Control Systems', 'Microprocessors'] },
    { sem: 4, title: 'Semester 4', papers: ['Electrical Machines', 'Power Electronics', 'Communications'] }
  ]
    ...
    <div>
      ...
      <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#666', fontSize: '16px', marginBottom: '30px' }}>
          Complete semester-wise question papers and study materials for Electrical Engineering
        </p>
