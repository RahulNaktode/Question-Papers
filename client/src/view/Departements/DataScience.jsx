...
function DataScience() {
  ...
  const semesters = [
    { sem: 1, title: 'Semester 1', papers: ['Python Programming', 'Statistics', 'Mathematics'] },
    { sem: 2, title: 'Semester 2', papers: ['Data Structures', 'SQL & Databases', 'Probability'] },
    { sem: 3, title: 'Semester 3', papers: ['Machine Learning', 'Data Visualization', 'Big Data'] },
    { sem: 4, title: 'Semester 4', papers: ['Deep Learning', 'NLP', 'Data Engineering'] }
  ]
    ...
    <div>
      ...
      <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#666', fontSize: '16px', marginBottom: '30px' }}>
          Complete semester-wise question papers and study materials for Data Science
        </p>
