...
function InformationTechnology() {
  ...
  const addQuestionPaper = async () => {
    ...
    const dataToSend = { 
    ...formData, 
    department: "InformationTechnology" // Department field set karein
  };
  ...
  try {
    const response = await axios.get('http://localhost:8030/questions', {
      params: { department: "InformationTechnology" } // Yeh backend mein ?department=InformationTechnology ban jayega
    });
    if (response.data.success) {
    ...
    <div className='bg-gray-50 min-h-screen'>
      ...
      <div className='p-4 max-w-7xl mx-auto'>
        ...
        <p className='text-gray-500 mb-3'>
          Complete semester-wise question papers and study materials for Information Technology
        </p>
