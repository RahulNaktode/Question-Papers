...
function ComputerScience() {
  ...
  const addQuestionPaper = async () => {
    ...
    const dataToSend = { 
    ...formData, 
    department: "ComputerScience" // Department field set karein
  };
  ...
  try {
    const response = await axios.get('http://localhost:8030/questions', {
      params: { department: "ComputerScience" } // Yeh backend mein ?department=ComputerScience ban jayega
    });
    if (response.data.success) {
    ...
    <div className='bg-gray-50 min-h-screen'>
      ...
      <div className='p-4 max-w-7xl mx-auto'>
        ...
        <p className='text-gray-500 mb-3'>
          Complete semester-wise question papers and study materials for Computer Science
        </p>
