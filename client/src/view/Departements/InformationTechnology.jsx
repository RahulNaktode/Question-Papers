...
function InformationTechnology() {
  ...
  const semesters = [
    { sem: 1, title: 'Semester 1', papers: ['Programming Fundamentals', 'Database Design', 'Web Technologies'] },
    { sem: 2, title: 'Semester 2', papers: ['Object-Oriented Programming', 'System Design', 'Networking'] },
    { sem: 3, title: 'Semester 3', papers: ['Software Engineering', 'Cloud Computing', 'Security'] },
    { sem: 4, title: 'Semester 4', papers: ['DevOps', 'Data Science', 'Enterprise Solutions'] }
  ]
    ...
    <div>
      ...
      <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#666', fontSize: '16px', marginBottom: '30px' }}>
          Complete semester-wise question papers and study materials for IT
        </p>
